...
export const metadata: Metadata = {
  title: "Elizabethtown Home Academy, by Rhoman James | 100% Free Courses",
  ...
  openGraph: {
    title: "Elizabethtown Home Academy, by Rhoman James — Every Kentucky Real Estate Course, Completely Free",
