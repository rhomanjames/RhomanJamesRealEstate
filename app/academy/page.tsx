...
export const metadata: Metadata = {
  title: "Kentucky Home Academy, by Rhoman James | $24/mo Full Access",
  ...
  openGraph: {
    title: "Kentucky Home Academy, by Rhoman James — Every Kentucky Real Estate Course, One Subscription",
