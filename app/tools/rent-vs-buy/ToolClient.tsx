      ...
      <ToolLayout num="04" title="Rent vs. Buy Calculator" description="See exactly when buying becomes cheaper than renting in Elizabethtown, KY — based on your real numbers.">
        <div className="tool-grid">
          <div className="tool-inputs">
            <div style={{ fontSize: "0.72rem", letterSpacing: "0.2em", textTransform: "uppercase", color: "var(--blue)", marginBottom: "1rem", borderBottom: "1px solid var(--border)", paddingBottom: "0.5rem" }}>Renting</div>
            ...
            <div style={{ fontSize: "0.72rem", letterSpacing: "0.2em", textTransform: "uppercase", color: "var(--blue)", margin: "1.75rem 0 1rem", borderBottom: "1px solid var(--border)", paddingBottom: "0.5rem" }}>Buying</div>
            ...
            <div style={{ fontSize: "0.72rem", letterSpacing: "0.2em", textTransform: "uppercase", color: "var(--blue)", margin: "1.75rem 0 1rem", borderBottom: "1px solid var(--border)", paddingBottom: "0.5rem" }}>Timeline</div>
            <SliderInput label="Years to Compare" value={years} min={1} max={15} step={1} onChange={setYears} display={`${years} year${years !== 1 ? "s" : ""}`} />
          </div>

          <div className="tool-results">
            <div style={{ padding: "1.75rem", background: savings > 0 ? "var(--border)" : "rgba(255,255,255,0.03)", border: `1px solid ${savings > 0 ? "var(--border)" : "var(--border)"}`, textAlign: "center", marginBottom: "1rem" }}>
              <div style={{ fontSize: "0.65rem", letterSpacing: "0.25em", textTransform: "uppercase", color: "var(--blue)", marginBottom: "0.5rem" }}>Over {years} Year{years !== 1 ? "s" : ""}</div>
              <div style={{ fontFamily: "'Inter', system-ui, sans-serif", fontSize: "2.2rem", fontWeight: 700, color: "var(--text)", lineHeight: 1.1 }}>{breakEven}</div>
