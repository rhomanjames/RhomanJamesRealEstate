    ...
    <>
      ...
      <main style={{ background:"var(--dark)",minHeight:"100vh",paddingTop:"5.5rem" }}>
        ...
        <div style={{ maxWidth:900,margin:"0 auto",padding:"3rem 2rem 6rem" }}>
          <h1 style={{ fontFamily:"'Cormorant Garamond', Georgia, serif",fontSize:"2rem",fontWeight:300,color:"white",marginBottom:"0.5rem" }}>Fort Knox PCS Homebuying Bootcamp</h1>
